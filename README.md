...
For Android Studio an integration plugin released to automate the process: [Android Studio plugin](https://github.com/Transround/NativerSDK/blob/master/tools/nativer-admin-plugin-android-studio/README.md).
